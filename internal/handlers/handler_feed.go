...
func HandlerGetFeeds(s *app.State, cmd cmd.Command) error {
	if len(cmd.Args) != 0 {
...
func HandlerAddFeed(s *app.State, cmd cmd.Command, user database.User) error {
	if len(cmd.Args) != 2 {
...
func HandlerFollowFeed(s *app.State, cmd cmd.Command, user database.User) error {
	if len(cmd.Args) != 1 {
...
func HandlerUnfollowFeed(s *app.State, cmd cmd.Command, user database.User) error {
	if len(cmd.Args) != 1 {
...
func HandlerFollowing(s *app.State, cmd cmd.Command, user database.User) error {
	if len(cmd.Args) != 0 {
		return fmt.Errorf("usage: %v", cmd.Name)
	}
